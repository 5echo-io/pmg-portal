...
urlpatterns = [
    ...
    path("customers/<slug:slug>/", views.customer_detail, name="admin_customer_detail"),
    path("customers/<slug:slug>/edit/", views.customer_edit, name="admin_customer_edit"),
    path("customers/<slug:slug>/delete/", views.customer_delete, name="admin_customer_delete"),
    path("customers/<slug:slug>/logo/", views.customer_logo_upload, name="admin_customer_logo_upload"),
    path("customers/<slug:slug>/logo/delete/", views.customer_logo_delete, name="admin_customer_logo_delete"),
    path("customers/<slug:slug>/logo-dark/", views.customer_logo_dark_upload, name="admin_customer_logo_dark_upload"),
    path("customers/<slug:slug>/logo-dark/delete/", views.customer_logo_dark_delete, name="admin_customer_logo_dark_delete"),
