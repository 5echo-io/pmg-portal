...
urlpatterns = [
    ...
    path("devices/", views.device_type_list, name="admin_device_list"),
    path("devices/add/", views.device_type_add, name="admin_device_type_add"),
    path("devices/<int:pk>/", views.device_type_detail, name="admin_device_type_detail"),
    path("devices/<int:type_pk>/instances/add/", views.device_instance_add, name="admin_device_instance_add"),
    path("devices/<int:type_pk>/instances/<int:instance_pk>/edit/", views.device_instance_edit, name="admin_device_instance_edit"),
    path("devices/<int:type_pk>/instances/<int:instance_pk>/delete/", views.device_instance_delete, name="admin_device_instance_delete"),
